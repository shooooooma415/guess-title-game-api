...
type mockThemeRepository struct {
	saveFunc    func(context.Context, *theme.Theme) error
	findByIDFunc func(context.Context, theme.ThemeID) (*theme.Theme, error)
	findAllFunc func(context.Context) ([]*theme.Theme, error)
	deleteFunc  func(context.Context, theme.ThemeID) error
}

func (m *mockThemeRepository) Save(ctx context.Context, t *theme.Theme) error {
	if m.saveFunc != nil {
...
func (m *mockThemeRepository) FindByID(ctx context.Context, id theme.ThemeID) (*theme.Theme, error) {
	if m.findByIDFunc != nil {
		return m.findByIDFunc(ctx, id)
	}
	return nil, errors.New("not implemented")
...
func (m *mockThemeRepository) FindAll(ctx context.Context) ([]*theme.Theme, error) {
...
func (m *mockThemeRepository) Delete(ctx context.Context, id theme.ThemeID) error {
	if m.deleteFunc != nil {
		return m.deleteFunc(ctx, id)
	}
	return errors.New("not implemented")
